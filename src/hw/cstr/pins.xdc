...
set_property IOSTANDARD LVCMOS18 [get_ports {fp_led[0]}]
set_property DRIVE 12 [get_ports {fp_led[0]}]
set_property SLEW FAST [get_ports {fp_led[0]}]

set_property PACKAGE_PIN G20 [get_ports {fp_led[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {fp_led[1]}]
set_property DRIVE 12 [get_ports {fp_led[1]}]
set_property SLEW FAST [get_ports {fp_led[1]}]

set_property PACKAGE_PIN F21 [get_ports {fp_led[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {fp_led[2]}]
set_property DRIVE 12 [get_ports {fp_led[2]}]
set_property SLEW FAST [get_ports {fp_led[2]}]

set_property PACKAGE_PIN F20 [get_ports {fp_led[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {fp_led[3]}]
set_property DRIVE 12 [get_ports {fp_led[3]}]
set_property SLEW FAST [get_ports {fp_led[3]}]

set_property PACKAGE_PIN E22 [get_ports {fp_led[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {fp_led[4]}]
set_property DRIVE 12 [get_ports {fp_led[4]}]
set_property SLEW FAST [get_ports {fp_led[4]}]

set_property PACKAGE_PIN E20 [get_ports {fp_led[5]}]
set_property IOSTANDARD LVCMOS18 [get_ports {fp_led[5]}]
set_property DRIVE 12 [get_ports {fp_led[5]}]
set_property SLEW FAST [get_ports {fp_led[5]}]

set_property PACKAGE_PIN D22 [get_ports {fp_led[6]}]
set_property IOSTANDARD LVCMOS18 [get_ports {fp_led[6]}]
set_property DRIVE 12 [get_ports {fp_led[6]}]
set_property SLEW FAST [get_ports {fp_led[6]}]

set_property PACKAGE_PIN D21 [get_ports {fp_led[7]}]
set_property IOSTANDARD LVCMOS18 [get_ports {fp_led[7]}]
set_property DRIVE 12 [get_ports {fp_led[7]}]
set_property SLEW FAST [get_ports {fp_led[7]}]
